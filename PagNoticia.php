        ...
        <div>
            <div>
                ...
                foreach ($novedades as $novedad) {
                    ...
                    // Descripcion
                    $html .= "<p>$novedad[fechaPublicacion]</p>";
                    $html .= "</div>";
                ...
                if ($comentarios->rowCount() < 1){
                    ...
                    $html .= "<h2>No hay comentarios, se el primero en decir algo</h2>";
                    $html .= "<button onclick='window.location.href=\"CrearComentario.php?noticiaDetalleID=" . urlencode($noticiaDetalleID) . "&usuarioID=". urldecode($_SESSION['UsuarioID']) ."\"'>Hazlo Aquí</button>";
                    $html .= "<div>";
