<?php
    ...
    $html .= "La pagina que buscas no existe";
    $html .= "<button class='btn btn-dark ml-4' onclick='window.location.href=\"index.php\"'>Volver a Inicio de Sesion</button>";
    $html .= "</div>";
    $html .= "<div class='text-center'>"; 
    $html .= "<img src='Imagenes/404.jpg' class='img-fluid mt-2' alt='Imagen'>";
    $html .= "</div>";
    $html .= "</div>";
    $html .= "</body>";
    $html .= "</html>";
