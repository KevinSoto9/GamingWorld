                ...
                <div class="col-md-3 mb-4 mt-4">
                    <div class="card bg-dark text-white">
                        <div class="card-body text-center">
                            ...
                            <h5 class="card-title"><a href="<?php echo $_SERVER['DOCUMENT_ROOT'] ?>/Web/PaginasIndividuales/PagDesarrollador.php?desarrolladorID=<?php echo $desarrolladorID; ?>" class="text-white"><?php echo $nombreDesarrollador; ?></a></h5>
                        </div>
                    </div>
                </div>
            <?php
