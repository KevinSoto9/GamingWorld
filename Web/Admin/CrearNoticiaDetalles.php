...
// Inserta los datos en la base de datos
                $ins = "INSERT INTO `noticias_detalles` (`noticiaDetalleID`, `noticiaID`, `titulo`, `descripcion`, `fechaPublicacion`, `urlNoticia`) VALUES (NULL, :noticiaID, :titulo, :descripcion, :fechaPublicacion, :urlNoticia)";
                $stmt = $bd->prepare($ins);
