            ...
            <div class="col-lg-12">
                <div class="card shadow-sm">
                    <div class="card-body bg-dark">
                        ...
                        <p>Si tienes alguna pregunta sobre esta Política de Privacidad, por favor contáctanos a través de nuestro formulario de contacto. <?php echo "<a class='text-white' href='/Web/PaginasPrincipales/Contactanos.php'>Contactanos</a>";?></p>
                    </div>
                </div>
            </div>
        </div>
