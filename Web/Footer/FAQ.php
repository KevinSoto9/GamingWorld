            ...
            <div class="col-lg-12">
                <div class="card shadow-sm">
                    <div class="card-body bg-dark">
                        ...
                        <h3>¿Cuánto tiempo tardaré en recibir mi clave de juego?</h3>
                        <p>Normalmente, recibirás tu clave de juego por correo electrónico de forma inmediata después de completar la compra. En casos excepcionales, puede haber un ligero retraso debido a la verificación del pago.</p>
