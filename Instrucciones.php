...
Primero insertar la información del juego
...
No hace falta información de géneros, desarrolladores o editores, solo la que pone en el formulario y enviarlo
Tras eso se debería haber añadido correctamente');

$pdf->RenderInstructions('-Instrucciones para crear una Noticia:', '
Primero debes crear la noticia principal en sí, sin detalles
Tras eso deberás poner los detalles de la noticia (el título y la imagen no son las mismas)
Si intentas ver la noticia sin haber creado sus detalles, esta no aparecerá
Tras haber insertado todo lo necesario deberías poder ver la noticia y toda la información de los detalles');
